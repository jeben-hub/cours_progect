Rails.application.configure do
  config.web_socket_server_url = "wss://mordor-fanfic.herokuapp.com/cable"
  ...
  config.action_cable.allowed_request_origins = [ 'https://mordor-fanfic.herokuapp.com', 'http://mordor-fanfic.herokuapp.com' ]
